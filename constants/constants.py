...
# TEAM_COLUMNS_DICT_COMBINED now resembles
# {
#     'meta': [list of <aggregated cols> and <unaggregated cols>],
#     'squad': [list of <aggregated cols> and <unaggregated cols>],
#     ...
# }
...
SCORES_COLUMNS_DICT = { # UPDATE THE TEAMS_DICT
    ...
    'attack': {
        'aggregated': [], # these are for current season... not previous season...
        'unaggregated': [
            'goals_for',
            'goals_for_home',
            'goals_for_away',
